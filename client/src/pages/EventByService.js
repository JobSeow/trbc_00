...
//   } = props;
  ...
  return (
    <>
      <Banner name= {dataToInsert.key} image={image}>
      ...
      <div className="main-container">
        ...
        <Row gutter={[60, 60]}>
          ...
          <Col sm={24} lg={12}>
            ...
            <Title style={{ textAlign: "left" }}>{dataToInsert.title}</Title>
            <hr align="left" className="thick-line"></hr>

            <div dangerouslySetInnerHTML={{ __html: dataToInsert.writeup }} style={{textAlign:"left"}}></div>
            <Card
              bodyStyle={{

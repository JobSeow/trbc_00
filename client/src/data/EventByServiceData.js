const data = [
  {
    ...
    writeup: `崇拜理念: 神创造人的目的乃要叫人晓得以心灵和诚实的敬拜祂。 【约翰福音4:24】\n
      <br/>
      崇拜分为三个领域：\n
      <br/>
      <br/>
  ...
  },
  {
    ...
    writeup: `“你 要 尽 心 ， 尽 性 ， 尽 力 爱 耶 和 华 你 的 神 。”
     - 申命记6:5\n
  ...
  },
  {
    ...
    writeup: `少年助道会是一个1318的团契； 换句话说，这个团契主要服事13至18岁的少年们。这个年龄层横跨了中学到高中的学生期。在这段成长的过程中，少年助道会盼望透过活动、讲座、营会，让这一群少年人能够在主的话语上扎根，在神的爱中与弟兄姐妹们建立关系，更重要的是装备他们面对现今社会的挑战。\n
  ...
  },
  {
    ...
    writeup: `潮华崇拜的细胞小组开始于2005年10 月，当时由林兴成传道和郑美娥理事各带领一个小组。 细胞小组的目的：建立关系（破冰），同声敬拜（赞美）、装备生命（查考神的话），彼此关怀（分享和代祷）。 迄今我们共有七个小组，由林兴成传道，林碧倩传道，陈保华传道，林永得执事、陈宝华理事、吴奕鸾姐妹，林莲玉姐妹和许恂如弟兄来带领。`,
    time: "TBC",
    location: "TBC",
  },
  {
  ...
  },
  {
    ...
    <br/>
      "And let us consider how we may spur one another on toward love and good deeds, 25 not giving up meeting together, as some are in the habit of doing, but encouraging one another—and all the more as you see the Day approaching." <br/>

      <b>Hebrews 10:24-25</b><br/>
      <br/>\n
      SPUR was officially formed on 8 Januaray 2011. <br/>Its main purpose is to bring the teens and youths together for better bonding and for collective teaching.\n
      ...
      Through SPUR we hope to nurture every youth to become a godly Christian and to live a purpose driven life.<br/><br/>`,
  ...
  },
  {
    ...
    <br/>
    <br/>  
    <b>Mission:</b> To disciple children into Christ-likeness through the teaching and obedience of His Word, to bear witness for Christ and to serve and worship God.\n
      The Children's Ministry consists of Children Worship and Sunday School.<br/><br/>`,
    time: "Sunday, 5 - 645pm",
  ...
  },
  {
    ...
    writeup: `"I have given them the glory that you gave me, that they may be one as we are one— 23 I in them and you in me—so that they may be brought to complete unity. Then the world will know that you sent me and have loved them even as you have loved me."<br/> <b>John 17:22-23</b><br/><br/>\n
      ...
      <br/>
      <br/>
      Christian Fellowship seeks:<br/>\n
      • To constantly remind us that we are fellow-partakers of God's grace.<br/>\n
      • To encourage praying for one another<br/>\n
      • To encourage serving in church together.<br/>\n
      • To develop heartfelt affection for one another.<br/><br/>`,
    time: "TBC",
    location: "TBC",
  },
  {
    ...
    writeup:
      "A time of unity with fellow believers in the presence of the Lord<br/><br/>",
  ...
  },
  {
    ...
    writeup: `Youths (ages 13 to 19) gather every Sunday at 11.00am in various classes for a time of bible study. 4 classes run concurrently at this time. We are now doing a survey of the Old Testament using Huang Sabin’s OT Made Simple as bible study resource.`,
    time: "Sunday, 11am",
    location: "3rd Floor ",
  },
  {
    ...
    writeup: `The Wonderkids Ministry comprises of simple people with a simple task: to introduce children from 4 to 12, to the wonders of the Bible and to our Lord Jesus Christ.\n
  ...
  },
  {
    ...
    writeup: `Prayer is fundamental to our Church life and forms a very critical pillar of our Church. We believe that all our ministries must be build upon prayer. Apart from the weekly prayers in our CG fellowship we also gather on the first Friday of every month to pray together as a body.\n
